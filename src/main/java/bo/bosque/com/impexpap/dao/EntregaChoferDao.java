...
public class EntregaChoferDao implements IEntregaChofer {
     ...
     *
     * @param docDate@return
     */
    @Override
    public List<EntregaChofer> listarEntregasXChofer(String docDate) {
        List<EntregaChofer> lstTemp = new ArrayList<>();

        try {
            lstTemp =  this.jdbcTemplate.query("execute p_list_trch_Entregas @docDate=?, @ACCION = ?",
                    new Object[] { docDate, "B" },
